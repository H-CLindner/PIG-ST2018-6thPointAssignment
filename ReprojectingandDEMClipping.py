...
def reprojectandGetElevFromDEM(rasterPath, shpPath, shpOutput):
    ...
    if caps & QgsVectorDataProvider.AddAttributes:
        ...
        res = shape_layer.dataProvider().addAttributes(
            [QgsField("dem_elev", QVariant.String)])
            
    shape_layer.updateFields()
    field_name_i_search = 'dem_elev'
    index = 0
    ...
    for feat in shape_layer.getFeatures():
        ...
        updates[feat.id()] = {index: str(demElev[feat.id()])}
