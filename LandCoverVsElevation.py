...
fig.savefig(os.path.join(savePath, 'maxMeanPlotRuhrRhein.png'), bbox_inches='tight')
...
fig2.savefig(os.path.join(savePath, 'minMeanPlotRuhrRhein.png'), bbox_inches='tight')